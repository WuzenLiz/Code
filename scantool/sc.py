...
parser.add_argument('-t', '--threads', default=50, help='threads')
#Credit to SardinasA for the below credscan idea/code
parser.add_argument('-c', '--credscan', default='y', help='Execute Credential Pull y/n With great power comes great (defaults to "n")')
